        ...
        >
          ...
          <Typography variant="body1" component="p" className={classes.subtext}>
            ...
            <Typography
              ...
              className={classes.authors}
            >
              {volumeInfo.publisher ? volumeInfo.publisher : null} ,{" "}
              {volumeInfo.publishedDate ? volumeInfo.publishedDate : null}
            </Typography>
          </Typography>
          {!isCollection ? (
            <Typography
            ...
            >
              ...
              <Typography variant="body2" component="span">
                {volumeInfo.description
                  ? truncate(volumeInfo.description, 100)
                  : null}
              </Typography>
            </Typography>
          ) : null}
        ...
        >
          {!isCollection ? (
            <Button
              variant="outlined"
              color="primary"
              onClick={() => addBook(user._id, book.id)}
            >
              Add To List
            </Button>
          ) : (
            <Button
              variant="outlined"
              color="primary"
              onClick={() => removeBook(user._id, volumeInfo._id)}
            >
              Remove
            </Button>
          )}
